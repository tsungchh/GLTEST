...
void Geometry::loadArrays() const
{
    ...
    glTexCoordPointer(2, GL_FLOAT, sizeof(tex2d), &texCoor);
}
...
void Patch::addtex2d(const tex2d &n) {

    geom->texCoor.append(n);

}


void Patch::setColor(QColor c)
{
    qSetColor(this->faceColor, c);
}
